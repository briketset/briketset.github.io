...
function init() {
    ...
    function createMeshs() {
        ...
        mesh_cube_1.position.set(0, 1, 0);
        ...
        mesh_cube_2.position.set(1, 1, 0);
        ...
        mesh_cube_3.position.set(2, 1, 0);
        scene.add(mesh_cube_3); 
        
        mesh_cube_4 = mesh_cube_2.clone();
        mesh_cube_4.position.set(3, 1, 0);
    ...
    function update() {
        ...
        for ( const mixer of mixers ) {
          ...
          mixer.update( delta );
          mixer._root.rotation.y += 0.02;
        // console.log(mixer._root.rotation)
      
        }

        // mixers[1].rotation.y += 0.02;

  
        // console.log(mixers[0].time)
        

        // mixers[0]._root.positionX += 0.2;
        // mixers[0]._root.rotation.y += 0.02;
        ...
        // m.copyPosition(mesh_cube.matrix);
        // // console.log(`${pos.elements[12]}  ${pos.elements[13]}   ${pos.elements[14]}`)

        // var pos = new THREE.Vector3( 10, 0.1, 0.1 );
        // pos.setFromMatrixPosition(m);
        // console.log(pos)

        // console.log(mesh_cube.position)

        camera.lookAt(mesh_cube.position)

        // let a = new THREE.Vector3(0.01, 0.0, -0.01)
        // camera.position.add(a) 
        // camera.position.x = mesh_cube.position.x


        // console.log(camera.position)

        // let c = new THREE.Vector3(1, 0, 0)       
        // let d = new THREE.Vector3(0, 1, 0)uheggt
        ...
        var axis = mesh_cube_4.position;

        // console.log(mesh_cube_4.position)
        // console.log(train.children[3])
// console.log(axis)

        let distance = 0.001;

        mesh_cube.translateOnAxis(axis, distance);
